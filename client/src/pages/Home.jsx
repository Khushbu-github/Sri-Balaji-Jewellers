...
const Home = () => {
 ...
 >
   ...
   <div className="text-center mb-6 sm:mb-8 md:mb-12">
     <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-2 sm:mb-3 text-gray-800">
   ...
   <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
     {/* Testimonial 1 */}
     <div className="bg-white rounded-2xl shadow-md p-5 sm:p-6 flex flex-col">
       <div className="flex justify-center mb-3">
         <div className="w-14 h-14 bg-amber-400 rounded-full flex items-center justify-center text-white text-2xl font-bold">
           "
         </div>
       </div>
       <div className="flex justify-center mb-3">
       ...
       <p className="text-gray-700 text-sm sm:text-base text-left mb-4 leading-relaxed italic flex-grow">
       ...
       <div className="flex items-center gap-3 mt-auto">
         <div className="w-12 h-12 bg-amber-500 rounded-full flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
           V
         </div>
         <div>
           <h4 className="font-bold text-gray-800 text-base">Vikram Singh</h4>
           <p className="text-gray-600 text-xs">HSR Layout, Bengaluru</p>
         </div>
       </div>
     </div>
     ...
     <div className="bg-white rounded-2xl shadow-md p-5 sm:p-6 flex flex-col">
       ...
       <div className="flex items-center gap-3 mt-auto">
         ...
         <div>
           <h4 className="font-bold text-gray-800 text-base">Priya Sharma</h4>
           <p className="text-gray-600 text-xs">Jayanagar, Bengaluru</p>
         </div>
       </div>
     </div>
     ...
     <div className="bg-white rounded-2xl shadow-md p-5 sm:p-6 flex flex-col">
       ...
       <div className="flex items-center gap-3 mt-auto">
         ...
         <div>
           <h4 className="font-bold text-gray-800 text-base">Rajesh Kumar</h4>
           <p className="text-gray-600 text-xs">Indiranagar, Bengaluru</p>
         </div>
       </div>
     </div>
   </div>
   ...
   <div className="text-center mt-8 sm:mt-12 md:mt-16">
     ...
     <Link to="/contact">
       <button className="bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 px-8 sm:py-4 sm:px-12 rounded-full text-base sm:text-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
         Visit Our Store
       </button>
     </Link>
   </div>
